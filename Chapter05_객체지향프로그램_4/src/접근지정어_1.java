 ...
 *				 생성자 , 메소드
 *	-----------------------------------------------------------------------------
 *	protected 	멤버변수 , 생성자 ,			같은 폴더(패키지)			
 *					 메소드				또는 상속받은 클래스				다른 폴더에서 사용이 불가능
 *										=> 다른 폴더에 있는 경우
 *	-----------------------------------------------------------------------------
 *	default		클래스 , 멤버변수 ,			같은 폴더에서만 접근 가능			다른 폴더에서 사용이 불가능
 *				 생성자 , 메소드
 *	-----------------------------------------------------------------------------
 *	private		멤버변수 , 생성자 ,			자신의 클래스내부					클래스 외부에서 사용이 불가능
 *					 메소드
 *	-----------------------------------------------------------------------------
 *	=> 크기
 ...
 * 
 * 	클래스 : public / default => public 권장 : 모든 클래스 사용
