 ...
 *								| 상속
 *								| 인터페이스 : 연결 
 *		=> 결합성이 높다 => 클래스수정시에 다른 클래스에 영향을 미친다
 *		  --------- 스프링 (로드존슨)
 ...
 *	-------------------------------------------------------
 	   CBC => 컴포넌트 베이스
 	   	   ...
 	   	   ---- 모든 멤버관련 => 메소드 , 변수 앞에 반드시 this.
 	   	   		최근에는 충돌만 안되면 this. 생략 => 컴파일러에 의해 자동 설정
 	   	   		
 	   	   		컴파일러가 자동 처리
 	   	   		=> import java.lang.* ;
 	   	   		=> 모든클래스는 Object 상속
 	   	   		class A extends Object ==> 안써도 자동으로생성
