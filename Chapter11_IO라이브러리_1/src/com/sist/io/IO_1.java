 ...
 *  4. BufferedReadr / BufferedWriter
 ...
 *  		***8. 폴더안에 있는 모든 파일/폴더 => String[] listFilese
...
public class IO_1 {
	...
	public static void main(String[] args) {
		...
		File file=new File("c:\\javaDev\\move.txt");
