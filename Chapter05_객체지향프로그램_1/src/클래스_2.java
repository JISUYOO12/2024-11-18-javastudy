...
class Card
{
	char number; //2byte
	String type; //4byte
	// new를 이용해서 저장공간을 생성한후에 저장 => 여러개 사용이 가능
	static int width;
	static int height;
...
public class 클래스_2 {
	...
	public 클래스_2() {
		...
		System.out.println("c1안에 저장된 데이터 width:"+c1.height);
		Card c2= new Card();
		...
		System.out.println("c2안에 저장된 데이터 width:"+c2.height);
		System.out.println("c1안에 저장된 데이터 widht:"+c1.width);
		System.out.println("c1안에 저장된 데이터 height:"+c1.width);
		// static => 객체명.변수명
		// ----------> 클래스명.변수명
		Card.width=300;
...
//		Card => 
		...
		//c1 => number , type => 객체
		/*
		 * 객체 => 사용자 정의 클래스의 변수 => 여러개를 동시에 제어할 수 있다
		 * -- 여러개 변수를 저장할 수 있는 메모리 공간이름
		 ...
		 * 				| 생성자 => 반드시 클래스명과 동일
		 * 
		 * 메모리 주소안에 number라는 메모리에 접근
		 * ------------- c1.number
		 * 				 객체명.변수명
		 *   			 .은 메모리 주소 접근 연산자
		 *   			 scan.nextInt()
		 * 메모리 주소안에 type이라는 메모리에 접근
		 * 				c2.type
