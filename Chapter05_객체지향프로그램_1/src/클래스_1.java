 ...
 * 	  prorected => 같은 폴더안에서만 접근이 가능
 * 				예외) 상속받은 클래스는 다른 폴더에서도 접근이 가능
 *    defalut => 같은 폴더에서만 접근이 가능 (****************)
