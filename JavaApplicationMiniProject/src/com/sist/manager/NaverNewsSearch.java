...
public class NaverNewsSearch {
    ...
    public static List<NewsVO> newsSearchData(String fd)
    {
    	...
    	String clientId ="S9PE3ec4skLQabAJWxYQ"; //애플리케이션 클라이언트 아이디
        String clientSecret = "vHQ1pN3ks1"; //애플리케이션 클라이언트 시크릿
        ...
        try 
        {
        	...
        	for(int i=0;i<items.size();i++)
        	{
        		...
        		pubDate=new SimpleDateFormat("yyyy-MM-dd").format(vo);
        				//System.out.println("pubDate");
