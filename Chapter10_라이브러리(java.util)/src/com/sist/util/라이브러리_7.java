...
public class 라이브러리_7 {
	...
	public static void main(String[] args) {
		...
		System.out.println("월:"+(today.get(Calendar.MONTH)+1)); // Month => 0 => 저장: -1 , 읽기: +1;
		System.out.println("요일:"+today.get(Calendar.DATE));
		// week => 1부터 시작
		...
		System.out.println(today.get(Calendar.MONTH)+"의 마지막 날:"+today.getActualMaximum(Calendar.DATE));
	}
